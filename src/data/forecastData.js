...
const globalMonthly = {
  ...
  kpi: { acc: '87%', accSub: '▲ 22%', vol: '812K', volSub: '▲ 5%', q: '100', qSub: '38·41·21', var: '±16%', ship: '1.93M', shgr: '+3.5%', shvar: '-3.8%', asu: '1.2M', asuvar: '+3.8%', sl: '72%', hc: '-5.8%', aht: '11.0m', util: '84%' },
};
...
const monthly = {
  ...
  AMER: cloneRegion({ acc: '90%', accSub: 'At target' }),
  EMEA: cloneRegion({ acc: '85%', accSub: '▲ 15%' }),
  APJ: cloneRegion({ acc: '88%', accSub: '▲ 42%' }),
};
