  ...
  return (
    <div className="tab-panel active">
      <div className="plan-sel" style={{ marginBottom: '14px' }}>
        <button className={'plan-btn' + (view === 'calendar' ? ' active' : '')} onClick={() => setView('calendar')}>Fiscal Calendar</button>
        <button className={'plan-btn' + (view === 'holidays' ? ' active' : '')} onClick={() => setView('holidays')}>Holiday Calendar</button>
      </div>
