...
export default function ContactVolumeDetailNew() {
  ...
  // Region/Offering filter set, same as the existing table.
    ...
    <div className="card" style={{ marginBottom: '14px' }}>
      <div className="card-header">
        <div className="card-title">
          📞 Contact Volume Detail — New View (trial)
          <InfoBtn tip="<strong>Purpose</strong>Global rollup by default -- click the Global row (or Offering) for the Region/Sub Region/Offering breakdown, same data as the table above." />
        </div>
        <div className="card-dd">
          ...
          <DownloadBtn filename="contact-volume-detail-new" title="Download contact volume detail" rows={csvRows} />
        </div>
      </div>
